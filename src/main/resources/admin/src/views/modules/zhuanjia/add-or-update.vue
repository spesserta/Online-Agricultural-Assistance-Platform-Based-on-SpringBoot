	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="从业年限" prop="congyenianxian" >
					<el-input v-model="ruleForm.congyenianxian" placeholder="从业年限" clearable  :readonly="ro.congyenianxian"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="从业年限" prop="congyenianxian" >
					<el-input v-model="ruleForm.congyenianxian" placeholder="从业年限" readonly></el-input>
				</el-form-item>
			</template>
			<el-form-item class="textarea" v-if="type!='info'" label="研究领域" prop="yanjiulingyu" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
					placeholder="研究领域"
					v-model="ruleForm.yanjiulingyu" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.yanjiulingyu" label="研究领域" prop="yanjiulingyu"  class="textBox">
				<span class="text">{{ruleForm.yanjiulingyu}}</span>
			</el-form-item>
			...
			<el-form-item v-else-if="ruleForm.gerenjianjie" label="个人简介" prop="gerenjianjie"  class="textBox">
			...
			init(id,type ) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='yanjiulingyu'){
							this.ruleForm.yanjiulingyu = obj[o];
							this.ro.yanjiulingyu = true;
							continue;
						}
						if(o=='gerenjianjie'){
