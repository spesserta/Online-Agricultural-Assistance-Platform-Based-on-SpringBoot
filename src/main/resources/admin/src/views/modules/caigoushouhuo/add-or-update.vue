	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item v-else class="input" label="采购总价" prop="caigouzongjia" >
				...
				<el-form-item class="date" v-if="type!='info'" label="收货时间" prop="shouhuoshijian" >
					<el-date-picker
						...
						type="datetime"
						:readonly="ro.shouhuoshijian"
						placeholder="收货时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item class="input" v-else-if="ruleForm.shouhuoshijian" label="收货时间" prop="shouhuoshijian" >
					<el-input v-model="ruleForm.shouhuoshijian" placeholder="收货时间" readonly></el-input>
				</el-form-item>
			...
			<el-form-item class="textarea" v-if="type!='info'" label="收货备注" prop="shouhuobeizhu" >
				<el-input
			...
			<el-form-item v-else-if="ruleForm.shouhuobeizhu" label="收货备注" prop="shouhuobeizhu"  class="textBox">
				<span class="text">{{ruleForm.shouhuobeizhu}}</span>
			</el-form-item>
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `caigoushouhuo/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.caigoushouhuoCrossAddOrUpdateFlag = false;
											this.parent.search();
										}
									});
								} else {
