	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="高校地址" prop="gaoxiaodizhi" >
					<el-input v-model="ruleForm.gaoxiaodizhi" placeholder="高校地址" clearable  :readonly="ro.gaoxiaodizhi"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="高校地址" prop="gaoxiaodizhi" >
					<el-input v-model="ruleForm.gaoxiaodizhi" placeholder="高校地址" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="高校电话" prop="gaoxiaodianhua" >
					<el-input v-model="ruleForm.gaoxiaodianhua" placeholder="高校电话" clearable  :readonly="ro.gaoxiaodianhua"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="高校电话" prop="gaoxiaodianhua" >
					<el-input v-model="ruleForm.gaoxiaodianhua" placeholder="高校电话" readonly></el-input>
				</el-form-item>
				<el-form-item class="upload" v-if="type!='info' && !ro.touxiang" label="高校封面" prop="touxiang" >
					<file-upload
						tip="点击上传高校封面"
						action="file/upload"
						:limit="3"
				...
				<el-form-item class="upload" v-else-if="ruleForm.touxiang" label="高校封面" prop="touxiang" >
			...
			<el-form-item class="textarea" v-if="type!='info'" label="高校简介" prop="gaoxiaojianjie" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
					placeholder="高校简介"
					v-model="ruleForm.gaoxiaojianjie" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.gaoxiaojianjie" label="高校简介" prop="gaoxiaojianjie"  class="textBox">
				<span class="text">{{ruleForm.gaoxiaojianjie}}</span>
			</el-form-item>
			...
			init(id,type ) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='gaoxiaodizhi'){
							this.ruleForm.gaoxiaodizhi = obj[o];
							this.ro.gaoxiaodizhi = true;
							continue;
						}
						if(o=='gaoxiaodianhua'){
							this.ruleForm.gaoxiaodianhua = obj[o];
							this.ro.gaoxiaodianhua = true;
							continue;
						}
						if(o=='touxiang'){
						...
						if(o=='gaoxiaojianjie'){
							this.ruleForm.gaoxiaojianjie = obj[o];
							this.ro.gaoxiaojianjie = true;
							continue;
						}
						if(o=='money'){
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `gaoxiao/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.gaoxiaoCrossAddOrUpdateFlag = false;
											this.parent.search();
										}
									});
								} else {
