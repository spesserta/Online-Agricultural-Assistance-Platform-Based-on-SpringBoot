const base = {
	get() {
		return {
			url : "http://localhost:8014/zhunong79djy629/",
			name: "zhunong79djy629",
			// 退出到首页链接
			indexUrl: 'http://localhost:8014/zhunong79djy629/front/dist/index.html'
		};
	},
	getProjectName(){
		return {
			projectName: "基于SpringBoot的网上助农平台设计与实现"
		} 
	},
	getUsersName(){
		return {
